...
class Transcribe_Complex(Species):
    ...
    def __init__(self, name, prom_rep, copy_number, count=False):
...
class NextReactionMethod(object):
    ...
    def PR_PRM_model_config_update1(self, copy, val, system_time, tau_list):
        ...
        Q = [i for i in self.PR_PRM_isomer_const if i == val[0]]
        ...
        if len(V) == 1:
            for i in range(len(self.occupancy_reaction1[copy][val[0]])):
                ...
                if len(Q) == 0:
                    ...
                    R.get_propensity(const=True,transcript=val[1])
    ...
    def PRE_model_config_update2(self, copy, val, system_time, tau_list):
        ...
        Q = [i for i in self.PRE_isomer_const if i == val[0]]
